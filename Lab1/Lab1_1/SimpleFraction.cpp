...
bool SimpleFraction::operator==(const SimpleFraction &simpleFraction)
{
    if (this->numerator == simpleFraction.numerator && this->denominator == simpleFraction.denominator)
        return true;
